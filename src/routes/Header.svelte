<header class="bg-black bg-lum5 white sd:px1 row justify-between">
  ...
  <nav class="px05 row">
    <a class="block px05 py1" href="https://github.com/lemmon/suil" target="_blank" rel="external noreferrer"
    ...
    >
    <a class="block px05 py1" href="https://www.npmjs.com/package/suil" target="_blank" rel="external noreferrer"
      ><svg class="block" width="24" height="24" viewBox="0 0 16 16" fill="currentColor">
